...
public class Normalize {
    ...
    public static class NormalizeReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            //inputkey = movieA, inputvalue=<movieB:relation, movieC:relation...>
            //sum up all relations -> denominator
            //iterate each relatino -> relation/denominator -> normalized relation
            //outputKey: movieB
            //outputValue: movieA=normalizedRelation
            int sum = 0;
            Map<String, Integer> map = new HashMap<String, Integer>();
            //Why Map: Iterable only can iterate one time!!!
